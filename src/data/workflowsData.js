  ...
  moleculeFinder: {
    ...
    sections: [
      ...
      },
      {
        ...
        subtitle: "2-objective NSGA-II starting from <strong>30 flavanone/chalcone PubChem compounds</strong> seeded on Homoeriodictyol. Maximizing <strong>P(sweet)</strong> (FartDB taste RF) while minimizing <strong>MW</strong>. Pareto front reveals the trade-off between predicted sweetness and molecular size.",
        gradient: "from-orange-600 via-rose-600 to-pink-600",
      },
      {
        id: 5,
        title: "case: safety-constrained design",
        subtitle: "3-objective NSGA-II adding <strong>P(safe AMES)</strong> — predicted by a RandomForest trained on the AMES mutagenicity dataset — to P(sweet) + MW optimisation. A structural purity filter (no halogens, no metals) is applied before the run. The Pareto front balances <strong>predicted sweetness · molecular size · predicted mutagenic safety</strong> simultaneously.",
        gradient: "from-violet-600 via-purple-600 to-fuchsia-600",
      },
      {
        id: 6,
        title: "safety & compliance",
        subtitle: "Apply a two-stage safety gate to the Pareto-optimal pool. First, predict a mutagenicity score using a model trained on <strong>AMES mutagenicity scores</strong>. Then a go/no-go filter: candidates are cross-referenced against <strong>FEMA GRAS</strong> (US) and <strong>EU Regulation EC 1334/2008</strong>.",
