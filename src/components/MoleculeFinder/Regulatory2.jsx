...
const RUN_OPTIONS = [
  { value: "2obj", label: "Case: Lipophilicity-Guided Design", sub: "607 aromatic compounds · logD + SA Score" },
  { value: "3obj", label: "Case: Sweetness Enhancer Discovery", sub: "325 DHC/flavanone compounds · P(sweet) + MW + logS" },
