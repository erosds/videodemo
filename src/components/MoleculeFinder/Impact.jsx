const MetricCard = ({ value, unit, label, sub, color, href }) => (
  <a
    href={href}
    target="_blank"
    ...
    <div className="max-w-6xl mx-auto w-full">
      ...
      <div className="grid grid-cols-4 gap-3 mb-3">
        ...
        <MetricCard
          ...
          sub="AI reduces physical prototyping costs"
          color="#6366f1"
          href="https://www.mckinsey.com/industries/chemicals/our-insights/global-chemical-industry-trends"
        />
      </div>
        ...
        <div className="rounded-xl border border-gray-800 bg-[#111111] p-5">
          ...
          <div className="grid grid-cols-2 gap-x-6">
            ...
            <div>
              ...
              <TimelineItem phase="Regulatory change" duration="Day 0" desc="Automated monitoring flags new restriction via digital database" color="#f43f5e" />
              <TimelineItem phase="Multi-objective screening" duration="< 1 h" desc="Candidates ranked by predicted odour similarity & safety" color="#ec4899" />
              <TimelineItem phase="Top candidates" duration="Day 1" desc="Ranked by odour profile match, safety score and cost" color="#a855f7" />
              ...
              <TimelineItem phase="Reformulation validated" duration="6–10 wk" desc="Dossier compiled with AI predictions as evidence" color="#6366f1" last />
            </div>
          </div>
        </div>
